...
import cn.org.shelly.edu.interceptor.AccessLimitInterceptor;
...
public class SaTokenConfigure implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        //  注册 AccessLimitInterceptor，拦截所有请求
        registry.addInterceptor(accessLimitInterceptor).addPathPatterns("/**"); // 拦截所有路径
